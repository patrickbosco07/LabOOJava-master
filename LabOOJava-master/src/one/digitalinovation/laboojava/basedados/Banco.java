...
public class Banco {
    ...
    public Cliente[] getCliente() {return cliente.toArray(new Cliente[cliente.size()]);}
    ...
    public void adicionarCliente(Cliente clientes) {cliente.add(clientes);};

    public void removerCliente(int posicao){cliente.remove(posicao);}
}
